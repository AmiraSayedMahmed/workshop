...
import 'package:workshop/presentation/screens/midterms/midterm_card_item.dart';
...
class MidtermsScreen extends StatelessWidget {
  ...
  List midtermModelDummyData = <Model>[
      ...
      body: ListView.builder(
        itemBuilder: (context, index) => Card(
          ...
          child: MidTermCardItem(
            midModel: midtermModelDummyData[index],
          ),
        ),
        itemCount: midtermModelDummyData.length,
